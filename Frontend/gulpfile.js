...
gulp.task('mintopjs', gulpScript.mintopjs);
...
// ===========================
var defaultTasks = gulp.series('clean-debug', 'assets', 'sass', 'css', 'copyScripts', 'mintopjs', 'fonts', 'images', 'html', 'watch', 'debug-size');
