<?php
namespace App\Payments\Payoo;

class Payment
{
    // Check Token Response
    const MER_ID = '11664';
    const BUSINESS_NAME = 'SB_TAKEONE';
    const SHOP_TITLE = 'TAKEONE';
    const CHECKSUM_KEY = 'MWVjZmZjZmFiZDdhNjY3NzI2MDdjZjNiMGZmNGRiYWY=';
    const API_USERNAME = 'SB_TAKEONE_BizAPI';
    const API_PASSWORD = '1syNZMDa/GTmLIw9';
    const API_SIGNATURE = 'NTluAHbxmjsvQMv2b+EXAdjXjSyWdB6Ukxe4HPS2XMyK563jawwjg9nhLZP4Nxzj';
	...
	const DOMAIN = 'https://newsandbox.payoo.com.vn/v2/paynow/order/create';
    ...
    public function createOrder($shop) {
        $data = array('data' => $shop,
                    'checksum' => hash('sha512', self::CHECKSUM_KEY.$shop),
                    'refer' => route('home'),
                    'bank' => '',
                    'payment_group' => 'CC,Bank-account,Payoo-account,QRCode',
                    'method' => 'CC,Bank-account,Payoo-account,QRCode',);

        return  self::sendRequest($data, self::DOMAIN);
    }
