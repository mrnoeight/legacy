...
<?php $__env->startSection('title', 'Tin tuc'); ?>

<?php $__env->startSection('hidden_page', 'Tin tuc'); ?>
...
<main id="pNews">
    ...
    <section class="section newsWrap animate">
        <div class="container">
            <div class="newsList">
                <?php $__currentLoopData = $oNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                    <div class="imgPage">
                        <div style="background: url(<?php echo e($news->banner_mb_url); ?>) center no-repeat"></div>
                        <img data-src="<?php echo e(asset('assets/images/b.gif')); ?>" class="lazyload" />
                    </div>
                    <div class="copy">
                        <h3><?php echo e($news->head_title1); ?></h3>
                        <div class="bot">
                            <p class="date"><?php echo e(\Carbon\Carbon::parse($news->block_date)->formatLocalized('%d %B %Y')); ?></p>
                            <a href="#">
                    ...
                    <a class="link" href="<?php echo e(route('news_detail', ['id'=>$news->id])); ?>"></a>
                </div>
...
<?php echo $__env->make('web.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\legacy\resources\views/web/news.blade.php ENDPATH**/ ?>