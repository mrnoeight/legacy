    ...
    <footer class="main-footer">
        <div class="wrap wrap-1200">
            <div>
                <a href="1-home.html" class="logo"><img src="<?php echo e(asset('assets/img/bg/logo.svg')); ?>"
                        alt="Take1 logo" /></a>
            ...
            <div>
                <nav>
                    ...
                    <ul class="menu">
                        <li><a href="<?php echo e(route('casting_board')); ?>">
                                <h6>Casting board</h6>
                            </a></li>
                        <li><a href="<?php echo e(route('our_talent')); ?>">
                                <h6>Meet our talents</h6>
                            </a></li>
                        <li><a href="<?php echo e(route('talent_service')); ?>">
                                <h6>Talent services</h6>
                            </a></li>
                        <li><a href="<?php echo e(route('casting_service')); ?>">
                ...
                <nav>
                    ...
                    <ul class="social-link">
                        <li><a href="https://www.twitter.com/" target="_blank"><img
                                    src="<?php echo e(asset('assets/img/bg/twitter.svg')); ?>" alt="twitter logo" />
                                <h6 class="hidden">twitter</h6>
                            </a></li>
                        <li><a href="https://www.youtube.com/" target="_blank"><img
                                    src="<?php echo e(asset('assets/img/bg/youtube.svg')); ?>" alt="youtube logo" />
                                <h6 class="hidden">youtube</h6>
                            </a></li>
                        <li><a href="https://www.facebook.com/" target="_blank"><img
                                    src="<?php echo e(asset('assets/img/bg/facebook.svg')); ?>" alt="facebook logo" />
    ...
    <script type="text/javascript">
        var web_root = '<?php echo e(route("home")); ?>';
    </script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/lib/jquery.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/lib/jquery.touch.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/lib/tween.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/main.js')); ?>"></script>
    <script type="text/javascript" defer src="<?php echo e(asset('assets/js/myfunc.js')); ?>"></script>
    <!-- Unexpected case-->
    <noscript>
    ...
    <?php if(isset($request) && $request->route()->named('megapay_callback')): ?>
    <script type="text/javascript">
        $( window ).on( "load", function() {

            <?php if($result['resultMsg'] == 'SUCCESS'): ?>
                APP.popup._alert.update('Payment Success', 'Thank you for purchasing the upgrade package!', '<a class="btn-gold-back" href="<?php echo e(route('home')); ?>">back to homepage</a>');
            ...
            <?php else: ?>
                APP.popup._alert.update('Payment failed', 'We are unable to process payment for this transaction. Please try again or contact us.', '<a class="btn-gold-back" href="<?php echo e(route('client_membership')); ?>" role="button">retry payment</a>');
                APP.popup._alert.show();
            <?php endif; ?>
        });
    </script>
    ...
    <?php if(isset($request) && $request->route()->named('payoo_callback')): ?>
    <script type="text/javascript">
        $( window ).on( "load", function() {

            <?php if($result['status'] == '1' && $is_good): ?>
                APP.popup._alert.update('Payment Success', 'Thank you for purchasing the upgrade package!', '<a class="btn-gold-back" href="<?php echo e(route('home')); ?>">back to homepage</a>');
                APP.popup._alert.show();
    ...
    <?php endif; ?><?php /**PATH C:\xampp2\htdocs\legacy\resources\views/web/partials/foot.blade.php ENDPATH**/ ?>