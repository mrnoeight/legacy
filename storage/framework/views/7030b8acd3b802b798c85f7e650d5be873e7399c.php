<div class="form-group row align-items-center" :class="{'has-danger': errors.has('name'), 'has-success': fields.name && fields.name.valid }">
    <label for="name" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.name')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.name" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('name'), 'form-control-success': fields.name && fields.name.valid}" id="name" name="name" placeholder="<?php echo e(trans('admin.talent-user.columns.name')); ?>">
        <div v-if="errors.has('name')" class="form-control-feedback form-text" v-cloak>{{ errors.first('name') }}</div>
    </div>
</div>

<div class="form-group row align-items-center" :class="{'has-danger': errors.has('email'), 'has-success': fields.email && fields.email.valid }">
    <label for="email" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.email')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.email" v-validate="'email'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('email'), 'form-control-success': fields.email && fields.email.valid}" id="email" name="email" placeholder="<?php echo e(trans('admin.talent-user.columns.email')); ?>">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('hometown'), 'has-success': fields.hometown && fields.hometown.valid }">
    <label for="hometown" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.hometown')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.hometown" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('hometown'), 'form-control-success': fields.hometown && fields.hometown.valid}" id="hometown" name="hometown" placeholder="<?php echo e(trans('admin.talent-user.columns.hometown')); ?>">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('birthday'), 'has-success': fields.birthday && fields.birthday.valid }">
    <label for="birthday" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.birthday')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.birthday" :config="datePickerConfig" v-validate="'date_format:yyyy-MM-dd HH:mm:ss'" class="flatpickr" :class="{'form-control-danger': errors.has('birthday'), 'form-control-success': fields.birthday && fields.birthday.valid}" id="birthday" name="birthday" placeholder="<?php echo e(trans('brackets/admin-ui::admin.forms.select_a_date')); ?>"></datetime>
        </div>
...
<div class="form-check row" :class="{'has-danger': errors.has('has_agency'), 'has-success': fields.has_agency && fields.has_agency.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="has_agency">
            <?php echo e(trans('admin.talent-user.columns.has_agency')); ?>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('agency_name'), 'has-success': fields.agency_name && fields.agency_name.valid }">
    <label for="agency_name" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.agency_name')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.agency_name" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('agency_name'), 'form-control-success': fields.agency_name && fields.agency_name.valid}" id="agency_name" name="agency_name" placeholder="<?php echo e(trans('admin.talent-user.columns.agency_name')); ?>">
...
<div class="form-check row" :class="{'has-danger': errors.has('want_agency'), 'has-success': fields.want_agency && fields.want_agency.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="want_agency">
            <?php echo e(trans('admin.talent-user.columns.want_agency')); ?>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('your_experience'), 'has-success': fields.your_experience && fields.your_experience.valid }">
    <label for="your_experience" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.your_experience')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.your_experience" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('your_experience'), 'form-control-success': fields.your_experience && fields.your_experience.valid}" id="your_experience" name="your_experience" placeholder="<?php echo e(trans('admin.talent-user.columns.your_experience')); ?>">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('socials'), 'has-success': fields.socials && fields.socials.valid }">
    <label for="socials" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.socials')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.socials" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('socials'), 'form-control-success': fields.socials && fields.socials.valid}" id="socials" name="socials" placeholder="<?php echo e(trans('admin.talent-user.columns.socials')); ?>">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('searching_for'), 'has-success': fields.searching_for && fields.searching_for.valid }">
    <label for="searching_for" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.searching_for')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.searching_for" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('searching_for'), 'form-control-success': fields.searching_for && fields.searching_for.valid}" id="searching_for" name="searching_for" placeholder="<?php echo e(trans('admin.talent-user.columns.searching_for')); ?>">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('profile_picture'), 'has-success': fields.profile_picture && fields.profile_picture.valid }">
    <label for="profile_picture" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.profile_picture')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.profile_picture" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('profile_picture'), 'form-control-success': fields.profile_picture && fields.profile_picture.valid}" id="profile_picture" name="profile_picture" placeholder="<?php echo e(trans('admin.talent-user.columns.profile_picture')); ?>">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('file_cv'), 'has-success': fields.file_cv && fields.file_cv.valid }">
    <label for="file_cv" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.talent-user.columns.file_cv')); ?></label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.file_cv" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('file_cv'), 'form-control-success': fields.file_cv && fields.file_cv.valid}" id="file_cv" name="file_cv" placeholder="<?php echo e(trans('admin.talent-user.columns.file_cv')); ?>">
...
<div class="form-check row" :class="{'has-danger': errors.has('weight'), 'has-success': fields.weight && fields.weight.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="weight">
            <?php echo e(trans('admin.talent-user.columns.weight')); ?>
...
<div class="form-check row" :class="{'has-danger': errors.has('height'), 'has-success': fields.height && fields.height.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="height">
            <?php echo e(trans('admin.talent-user.columns.height')); ?>
...
<?php /**PATH C:\xampp2\htdocs\take1\resources\views/admin/talent-user/components/form-elements.blade.php ENDPATH**/ ?>