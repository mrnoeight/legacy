...
<main id="pNewsDetail">
    ...
    <section class="section newsDetailWrap">
        <div class="container">
            <div class="top">
                <h4>Tin tức</h4>
                <h2 class="mainTt"><?php echo e($news->head_title1); ?></h2>
                <p class="date"><?php echo e(__('Ngày đăng')); ?>: <strong><?php echo e(\Carbon\Carbon::parse($news->block_date)->formatLocalized('%d %B %Y')); ?></strong></p>
                <p class="cap"><?php echo e($news->head_tag1); ?> </p>
            </div>
            <div class="content">
                <?php echo $news->head_desc1; ?>
    ...
    <section class="section newsWrap">
        <div class="container">
            <div class="newsList">
                <?php $__currentLoopData = $oNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                    <div class="imgPage">
                        <div style="background: url(<?php echo e($n->banner_url); ?>) center no-repeat"></div>
                        <img data-src="<?php echo e(asset('assets/images/b.gif')); ?>" class="lazyload" />
                    </div>
                    <div class="copy">
                        <h3><?php echo e($n->head_title1); ?></h3>
                        <div class="bot">
                            <p class="date"><?php echo e(\Carbon\Carbon::parse($n->block_date)->formatLocalized('%d %B %Y')); ?></p>
                            <a href="#">
                    ...
                    <a class="link" href="<?php echo e(route('news_detail', ['id'=>$n->id])); ?>"></a>
                </div>
