...
<main id="pApartment">
    <div class="bannerSubPage go-up">
        <img class="lazyload pc" data-src="<?php echo e(asset('assets/images/demo/banner-page-4.jpg')); ?>" alt="">
        <img class="lazyload mb" data-src="<?php echo e(asset('assets/images/demo/banner-page-4-mb.jpg')); ?>" alt="">
    ...
    <section id="masterplan" class="masterPlan  pd1">
        <div class="container">
            ...
            <div class="row checklenght animate">
                <img data-src="<?php echo e(asset('assets/images/demo/master-plan.jpg')); ?>" class="lazyload" />
    ...
    <section id="floorplan" class="floorplanWrap pd1">
        <div class="container">
            ...
            <div id="tab1" class="ctTab">
                <div class="row checklenght animate">
                    <img data-src="<?php echo e(asset('assets/images/demo/floorplan.png')); ?>" class="lazyload" />
                    <div class="listMasterPlan">
                        <div class="left">
                            <div index="1" class="itemPlace">
                                <span>01</span>
            ...
            <div id="tab2" class="ctTab">
                <div class="rooftopDesk">
                    <div class="l">
                        <div class="floorItem rightAl jsOpenFloor">
                            <div class="floor">
                                <img data-src="<?php echo e(asset('assets/images/demo/toa-c.png')); ?>" class="lazyload" />
                                <h3>toà c</h3>
                            </div>
                    ...
                    <div class="r">
                        <div class="floorItem leftAl jsOpenFloor">
                            <div class="floor">
                                <img data-src="<?php echo e(asset('assets/images/demo/toa-a.png')); ?>" class="lazyload" />
                                <h3>toà A</h3>
                            </div>
                ...
                <div class="rooftopMobile">
                    <div class="sliderrooftop">
                        <div class="item" style="background: url(<?php echo e(asset('assets/images/demo/toa-a.png')); ?>) center no-repeat;">
                            <h2>Toa A</h2>
                        </div>
                        <div class="item" style="background: url(<?php echo e(asset('assets/images/demo/toa-b.png')); ?>) center no-repeat;">
                            <h2>Toa B</h2>
                        </div>
                        <div class="item" style="background: url(<?php echo e(asset('assets/images/demo/toa-c.png')); ?>) center no-repeat;">
                            <h2>Toa C</h2>
                        </div>
...
<?php echo $__env->make('web.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\legacy\resources\views/web/apartment2.blade.php ENDPATH**/ ?>