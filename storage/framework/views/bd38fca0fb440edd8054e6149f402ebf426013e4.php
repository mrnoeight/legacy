...
<!-- MAIN PAGE -->
<main id="page-p2-talent-role-submit">
    <input type="hidden" id="page-id" value="page-p2-talent-role-submit" />
    <article class="main-article role-submit">
        <div class="wrap-1200 article-wrap">

            <div class="content-wrap redo-wrap type-2 p2-header-wrap">
                <header>
                    <ul class="breadcrumb full-w">
                        <li><a href="<?php echo e(route('talent_casting_board')); ?>">Billboard</a></li>
                ...
                <div class="intro-wrap no-img">
                    <div class="intro-content">
                        ...
                        <p class="gold-hl">Upgrade to a&nbsp;<a href="#">Premium Membership</a>&nbsp;in order to submit
                            to this role and unlock unlimited submissions!</p>
                        <span class="s-note">Changes made here will only apply to this submission. Your profile will not
                            be affected.</span>
                    </div>
                </div>
            </div>
            ...
            <form id="form-role-submit" data-url="<?php echo e(route('apply_role', ['id'=>$role->id])); ?>">
                ...
                <div class="btn-wrap">
                    <a href="<?php echo e(route('talent_role_detail', ['id'=>$role->id])); ?>" class="btn-txt">Cancel</a>
...
<?php echo $__env->make('web.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\take1\resources\views/web/talent_submit_role.blade.php ENDPATH**/ ?>