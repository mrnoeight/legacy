...
<?php $__env->startSection('hidden_page', 'News'); ?>
...
<main id="pNewsDetail">
    <div class="bannerSubPage">
        <img data-src="<?php echo e(asset('assets/images/demo/banner-page-3.jpg')); ?>" alt="" class="lazyload">
    </div>
    <section class="section newsDetailWrap">
        <div class="container">
            <div class="top">
                <h4>Tin tức</h4>
                <h2 class="mainTt">Lorem ipsum dolor sit amet, consectetur adipiscing elite</h2>
                <p class="date">Ngày đăng: <strong>02 apr 2022</strong></p>
                <p class="cap">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mollis pellentesque tincidunt
                    proin convallis euismod. Massa in porttitor viverra malesuada fermentum, nulla imperdiet enim.
                    Rhoncus sit ultrices velit aliquet. </p>
            </div>
            <div class="content">
                <p><img data-src="<?php echo e(asset('assets/images/demo/29.jpg')); ?>" alt="" class="lazyload"></p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mollis pellentesque tincidunt proin
                    convallis euismod. Massa in porttitor viverra malesuada fermentum, nulla imperdiet enim. Rhoncus sit
                    ultrices varius est laoreet velit aliquet. Orci, sed pulvinar nisl sit urna nec orci suspendisse.
                    Phasellus lorem at tortor eu volutpat sapien id sit sed. Tincidunt mauris in rhoncus rutrum. Rhoncus
                    a amet sed volutpat blandit. Arcu lacus mauris maecenas integer. Placerat commodo nec faucibus
                    consectetur nunc eget quis turpis aliquam.Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Mollis pellentesque tincidunt proin convallis euismod. Massa in porttitor viverra malesuada
                    fermentum, nulla imperdiet enim. Rhoncus sit ultrices varius est laoreet velit aliquet. Orci, sed
                    pulvinar nisl sit urna nec orci suspendisse. Phasellus lorem at tortor eu volutpat sapien id sit
                    sed. Tincidunt mauris in rhoncus rutrum. Rhoncus a amet sed volutpat blandit. Arcu lacus mauris
                    maecenas integer. Placerat commodo nec faucibus consectetur nunc eget quis turpis aliquam. Lorem
                    ipsum dolor sit amet, consectetur adipiscing elit. Mollis pellentesque tincidunt proin convallis
                    euismod. Massa in porttitor viverra malesuada fermentum, nulla imperdiet enim. </p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mollis pellentesque tincidunt proin
                    convallis euismod. Massa in porttitor viverra malesuada fermentum, nulla imperdiet enim. Rhoncus sit
                    ultrices varius est laoreet velit aliquet. Orci, sed pulvinar nisl sit urna nec orci suspendisse.
                    Phasellus lorem at tortor eu volutpat sapien id sit sed. Tincidunt mauris in rhoncus rutrum. Rhoncus
                    a amet sed volutpat blandit. Arcu lacus mauris maecenas integer.</p>
            </div>
        </div>
    </section>
    ...
    <section class="section newsWrap">
        <div class="container">
            <div class="newsList">
                <div class="item">
                    <div class="imgPage">
                        <div style="background: url(<?php echo e(asset('assets/images/demo/28.jpg')); ?>) center no-repeat"></div>
                        <img data-src="<?php echo e(asset('assets/images/b.gif')); ?>" class="lazyload" />
                    </div>
                    <div class="copy">
                        <h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit Elit senectus et metus</h3>
                        <div class="bot">
                            <p class="date">02 Mar 2022</p>
                            <a href="#">
...
<?php echo $__env->make('web.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\legacy\resources\views/web/news_detail.blade.php ENDPATH**/ ?>