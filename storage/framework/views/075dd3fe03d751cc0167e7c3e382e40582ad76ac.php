    ...
    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col"<?php if(!$loop->first): ?> v-show="isFormLocalized && currentLocale == '<?php echo e($locale); ?>'" v-cloak <?php endif; ?>>
            <div class="form-group row" :class="{'has-danger': errors.has('mid_title1_<?php echo e($locale); ?>'), 'has-success': this.fields.mid_title1_<?php echo e($locale); ?> && this.fields.mid_title1_<?php echo e($locale); ?>.valid }">
                <label for="mid_title1_<?php echo e($locale); ?>" class="col-md-2 col-form-label text-md-right">Health</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <textarea v-model="form.mid_title1.<?php echo e($locale); ?>" v-validate="''" class="form-control" :class="{'form-control-danger': errors.has('mid_title1_<?php echo e($locale); ?>'), 'form-control-success': this.fields.mid_title1_<?php echo e($locale); ?> && this.fields.mid_title1_<?php echo e($locale); ?>.valid }" id="mid_title1_<?php echo e($locale); ?>" mid_title1="mid_title1_<?php echo e($locale); ?>" placeholder=""></textarea>
    ...
    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col"<?php if(!$loop->first): ?> v-show="isFormLocalized && currentLocale == '<?php echo e($locale); ?>'" v-cloak <?php endif; ?>>
            <div class="form-group row" :class="{'has-danger': errors.has('mid_desc1_<?php echo e($locale); ?>'), 'has-success': this.fields.mid_desc1_<?php echo e($locale); ?> && this.fields.mid_desc1_<?php echo e($locale); ?>.valid }">
                <label for="mid_desc1_<?php echo e($locale); ?>" class="col-md-2 col-form-label text-md-right">Health Description</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <textarea v-model="form.mid_desc1.<?php echo e($locale); ?>" v-validate="''" class="form-control" :class="{'form-control-danger': errors.has('mid_desc1_<?php echo e($locale); ?>'), 'form-control-success': this.fields.mid_desc1_<?php echo e($locale); ?> && this.fields.mid_desc1_<?php echo e($locale); ?>.valid }" id="mid_desc1_<?php echo e($locale); ?>" mid_desc1="mid_desc1_<?php echo e($locale); ?>" placeholder=""></textarea>
    ...
    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col"<?php if(!$loop->first): ?> v-show="isFormLocalized && currentLocale == '<?php echo e($locale); ?>'" v-cloak <?php endif; ?>>
            <div class="form-group row" :class="{'has-danger': errors.has('info1_<?php echo e($locale); ?>'), 'has-success': this.fields.info1_<?php echo e($locale); ?> && this.fields.info1_<?php echo e($locale); ?>.valid }">
                <label for="info1_<?php echo e($locale); ?>" class="col-md-2 col-form-label text-md-right">Entertainment</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
    ...
    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col"<?php if(!$loop->first): ?> v-show="isFormLocalized && currentLocale == '<?php echo e($locale); ?>'" v-cloak <?php endif; ?>>
            <div class="form-group row" :class="{'has-danger': errors.has('info2_<?php echo e($locale); ?>'), 'has-success': this.fields.info2_<?php echo e($locale); ?> && this.fields.info2_<?php echo e($locale); ?>.valid }">
                <label for="info2_<?php echo e($locale); ?>" class="col-md-2 col-form-label text-md-right">Entertainment Description</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
    ...
    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col"<?php if(!$loop->first): ?> v-show="isFormLocalized && currentLocale == '<?php echo e($locale); ?>'" v-cloak <?php endif; ?>>
            <div class="form-group row" :class="{'has-danger': errors.has('info3_<?php echo e($locale); ?>'), 'has-success': this.fields.info3_<?php echo e($locale); ?> && this.fields.info3_<?php echo e($locale); ?>.valid }">
                <label for="info3_<?php echo e($locale); ?>" class="col-md-2 col-form-label text-md-right">Business </label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
    ...
    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col"<?php if(!$loop->first): ?> v-show="isFormLocalized && currentLocale == '<?php echo e($locale); ?>'" v-cloak <?php endif; ?>>
            <div class="form-group row" :class="{'has-danger': errors.has('info4_<?php echo e($locale); ?>'), 'has-success': this.fields.info4_<?php echo e($locale); ?> && this.fields.info4_<?php echo e($locale); ?>.valid }">
                <label for="info4_<?php echo e($locale); ?>" class="col-md-2 col-form-label text-md-right">Business Description</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <textarea v-model="form.info4.<?php echo e($locale); ?>" v-validate="''" class="form-control" :class="{'form-control-danger': errors.has('info4_<?php echo e($locale); ?>'), 'form-control-success': this.fields.info4_<?php echo e($locale); ?> && this.fields.info4_<?php echo e($locale); ?>.valid }" id="info4_<?php echo e($locale); ?>" info4="info4_<?php echo e($locale); ?>" placeholder=""></textarea>
...
<?php /**PATH C:\xampp2\htdocs\legacy\resources\views/admin/homepage/components/facilites.blade.php ENDPATH**/ ?>