<?php $__env->startSection('title', trans('admin.tag.actions.index')); ?>

<?php $__env->startSection('body'); ?>

    <tag-listing
        :data="<?php echo e($data->toJson()); ?>"
        :url="'<?php echo e(url('admin/tags')); ?>'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> <?php echo e(trans('admin.tag.actions.index')); ?>

                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="<?php echo e(url('admin/tags/create')); ?>" role="button"><i class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.tag.actions.create')); ?></a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'"><?php echo e(trans('admin.tag.columns.id')); ?></th>
                                        <th is='sortable' :column="'tag_name'"><?php echo e(trans('admin.tag.columns.tag_name')); ?></th>
                                        <th is='sortable' :column="'tag_name'"><?php echo e(trans('admin.tag.columns.tag_type')); ?></th>
                                    ...
                                    <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="4">
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3" @click="bulkDelete('/admin/tags/bulk-destroy')"><?php echo e(trans('brackets/admin-ui::admin.btn.delete')); ?></button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="<?php echo e(url('admin/tags/create')); ?>" role="button"><i class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.tag.actions.create')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('brackets/admin-ui::admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\take1\resources\views/admin/tag/index.blade.php ENDPATH**/ ?>