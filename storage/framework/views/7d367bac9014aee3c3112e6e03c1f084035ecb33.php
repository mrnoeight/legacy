...
<main id="page-talent-details">
    ...
    <section class="details-banner wrap-1200">
        ...
        <div class="intro-wrap">
            <img class="intro-img" src="<?php echo e($talent->cover_url); ?>" alt="<?php echo e($talent->name); ?>" />
            <div class="intro-content">
                <h4 class="heading"><?php echo e($talent->stage_name); ?></h4>
                <div class="info col-1">
                    <h5><i class="city">Location:&nbsp;</i><b><?php echo e($talent->hometown); ?></b></h5>
                    <h5><i class="gender">Gender:&nbsp;</i><b><?php echo e($talent->gender); ?></b></h5>
                    <h5><i class="age">Age Range:&nbsp;</i><b><?php echo e($talent->age); ?></b></h5>
                    <h5><i class="bday">Height:</i>&nbsp;<b><?php echo e($talent->height); ?>cm</b></h5>
                    <h5><i class="bday">Weight:</i>&nbsp;<b><?php echo e($talent->weight); ?>kg</b></h5>
                </div>
                ...
                <div class="btn-wrap">
                    ...
                    <svg width="18" height="22">
                        <path d="M12 6V18.97L7.79 17.16L7 16.82L6.21 17.16L2 18.97V6H12ZM16 0H5.99C4.89 0 4 0.9 4 2H14C15.1 2 16 2.9 16 4V17L18 18V2C18 0.9 17.1 0 16 0ZM12 4H2C0.9 4 0 4.9 0 6V22L7 19L14 22V6C14 4.9 13.1 4 12 4Z"/>
                    </svg>
                    </a>
        ...
        <div class="wrap-1200 article-wrap">
            ...
            <ul class="break-list content-wrap">
                ...
                <li class="exp">
                    ...
                    <p>Role Summary: A late night radio talk show host offers a room to a runaway teen at her opulent home, what she doesn't bargain for is the eighteen year old has ulterior motives which forces Kim to face her darkest secrets.</p>
                </li>
                <li class="exp">
...
<section class="how-it-works">
    <div class="wrap wrap-1200">
        <header>
            <h4 class="heading">How to Hire this Talent</h4>
        ...
        <div class="wrap">
            ...
            <div class="content">
                ...
                <div class="btn-wrap">
                    ...
                    <span>Or</span>
                    <a href="#" class="btn-black-arrow cta" role="button">
...
<div id="popup-login" class="popup-content">
  <div class="main-content">
    ...
    <section class="heading-wrap">
      ...
      <p class="desc">Don’t have an account? <a href="<?php echo e(route('signup')); ?>" role="button" class="btn-txt">Sign up here</a></p>
    </section>
    ...
    <form class="login-form" data-url="<?php echo e(route('login')); ?>">
      ...
      <div class="input-wrap">
        <div class="posrel">
          <input name="email" type="text" class="input js-required js-email" autocomplete="off" required-txt="Enter your Email Address" email-txt="Please enter a valid email address"/>
      ...
      <div class="input-wrap">
        <div class="posrel">
          <input name="password" type="password" class="input js-required js-min" autocomplete="off" data-min="2" required-txt="Please enter your password" min-txt="Password must be at least two characters"/>
...
<div id="popup-hire" class="popup-content">
  <div class="main-content">
    ...
    <form class="login-form" data-url="json/submit-hire-pass.json" data-event="popup-hire-passed">
      <p class="warning-server">Server errors show here!!!</p>
      <div class="input-wrap input-sel redo-input">
        <label>Project Name *</label>
        <div class="holder">
          <input type="hidden" name="hire-project"/>
          <input type="text" class="input js-required" autocomplete="off" required-txt="Select your project" placeholder="Select a Project" readonly/>
        </div>
        <p class="warning"></p>
        <ul class="opt-list">
          <li data-value="Project Value 1">Project Name 1</li>
          <li data-value="Project Value 2">Project Name 2</li>
          <li data-value="Project Value 3">Project Name 3</li>
          <li data-value="Project Value 4">Project Name 4</li>
          <li data-value="Project Value 5">Project Name 5</li>
        </ul>
      </div>
      ...
      <div class="input-wrap input-sel redo-input">
        ...
        <div class="holder">
          <input type="hidden" name="hire-role"/>
          <input type="text" class="input js-required" autocomplete="off" required-txt="Select your role" placeholder="Select a Role" readonly/>
        </div>
        <p class="warning"></p>
        <ul class="opt-list">
          <li data-value="Role Value 1">Role Name 1</li>
      ...
      <div class="form-wrap">
        ...
        <div class="chx-wrap">
          <div class="holder">
            ...
            <label for="chx-take1-tape"><img src="<?php echo e(asset('assets/img/video/take1-tape.svg')); ?>" alt="Take1 Tape"/>Take1 Tape</label>
          </div>
          <p class="warning"></p>
        </div>
        <div class="chx-wrap">
          <div class="holder">
            ...
            <label for="chx-self-tape"><img src="<?php echo e(asset('assets/img/video/self-tape.svg')); ?>" alt="Self Tape"/>Self Tape</label>
          </div>
          <p class="warning"></p>
        </div>
        <div class="chx-wrap">
          <div class="holder">
            ...
            <label for="chx-self-audition"><img src="<?php echo e(asset('assets/img/video/self-audition.svg')); ?>" alt="Self Audition"/>Self Audition</label>
          </div>
          <p class="warning"></p>
        </div>
      </div>
      ...
      <div class="input-wrap redo-input">
        ...
        <div class="holder">
          <input name="hire-instruction" type="text" class="input js-required" autocomplete="off" required-txt="Enter your Instruction" placeholder="More Description"/>
        </div>
        <p class="warning"></p>
      </div>
      ...
      <div class="input-wrap redo-input input-date">
        ...
        <div class="holder">
          <input name="hire-deadline" type="text" class="input js-required js-date" autocomplete="off" required-txt="Enter your Deadline" date-txt="Enter a valid date" placeholder="dd/mm/yyyy" maxlength="10"/>
        </div>
        <p class="warning"></p>
      </div>
      <div class="btn-wrap">
...
<?php echo $__env->make('web.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\take1\resources\views/web/talent_detail.blade.php ENDPATH**/ ?>