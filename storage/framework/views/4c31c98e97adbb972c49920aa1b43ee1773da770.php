                        ...
                        <div class="input-wrap redo-input js-active">
                            ...
                            <div class="holder">
                                <input name="email" type="text" class="input js-required js-email" autocomplete="off"
                                    ...
                                    placeholder="Email" value="<?php echo e($client->email); ?>" />
                            </div>
                            <p class="warning"></p>
                        </div>
...
<?php echo $__env->make('web.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\take1\resources\views/web/client_account_info.blade.php ENDPATH**/ ?>