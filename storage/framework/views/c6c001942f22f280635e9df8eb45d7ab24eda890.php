<?php $__env->startSection('title', trans('admin.registration.actions.edit', ['name' => $registration->name])); ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <div class="container-xl">
            ...
            <registration-form
                :action="'<?php echo e($registration->resource_url); ?>?stat=<?php echo e($stat); ?>'"
                :data="<?php echo e($registration->toJson()); ?>"
                ...
                <form class="form-horizontal form-edit" method="post" @submit.prevent="onSubmit" :action="action" novalidate>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-pencil"></i> <?php echo e(trans('admin.registration.actions.edit', ['name' => $registration->name])); ?>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-5 col-xxl-4">
                            <?php echo $__env->make('admin.registration.components.form-elements-right', ['showHistory' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('brackets/admin-ui::admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\take1\resources\views/admin/registration/edit.blade.php ENDPATH**/ ?>