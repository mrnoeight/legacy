...
<body>
    ...
    <header>
        <div class="container stagger-down">
            ...
            <div class="left">
                <nav>
                    <a href="<?php echo e(route('home')); ?>" <?php echo e($menu_active['home']); ?>><?php echo e(isset($arrMenuText['menu_home']) ? $arrMenuText['menu_home'] :  __('Trang chủ')); ?></a>
                    <a href="<?php echo e(route('home')); ?>#locationWrap" <?php echo e($menu_active['location']); ?>><?php echo e(isset($arrMenuText['menu_location']) ? $arrMenuText['menu_location'] : __('Vị trí')); ?></a>
                    <a href="<?php echo e(route('apartment')); ?>" <?php echo e($menu_active['apartment']); ?>><?php echo e(isset($arrMenuText['menu_apartment']) ? $arrMenuText['menu_apartment'] : __('Thông tin căn hộ')); ?></a>
                    <a href="<?php echo e(route('tienich')); ?>" <?php echo e($menu_active['utilities']); ?>><?php echo e(isset($arrMenuText['menu_amenities']) ? $arrMenuText['menu_amenities'] : __('Tiện ích')); ?></a>
                    <a href="<?php echo e(route('gallery')); ?>" <?php echo e($menu_active['gallery']); ?>><?php echo e(isset($arrMenuText['menu_gallery']) ? $arrMenuText['menu_gallery'] : __('Thư viện')); ?></a>
            ...
            <div class="right">
                <nav>
                    <a href="<?php echo e(route('news')); ?>" <?php echo e($menu_active['news']); ?>><?php echo e(isset($arrMenuText['menu_news']) ? $arrMenuText['menu_news'] : __('Tin tức')); ?></a>
                    ...
                    <a href="<?php echo e(route('progress')); ?>" <?php echo e($menu_active['progress']); ?>><?php echo e(isset($arrMenuText['menu_progress']) ? $arrMenuText['menu_progress'] :  __('Tiến độ')); ?></a>
                    <a href="<?php echo e(route('home')); ?>#infomationWrap" <?php echo e($menu_active['about']); ?>><?php echo e(isset($arrMenuText['menu_contact']) ? $arrMenuText['menu_contact'] :  __('Liên hệ')); ?></a>
                </nav>
                <div class="lang">
        ...
        <div class="navMobile">
            <nav class="menufix">
                <ul>
                    ...
                    <li><a href="<?php echo e(route('gallery')); ?>" <?php echo e($menu_active['gallery']); ?>><?php echo e(isset($arrMenuText['menu_gallery']) ? $arrMenuText['menu_gallery'] : __('Thư viện')); ?></a></li>

                    <li><a href="<?php echo e(route('news')); ?>" <?php echo e($menu_active['news']); ?>><?php echo e(isset($arrMenuText['menu_news']) ? $arrMenuText['menu_news'] : __('Tin tức')); ?></a></li>
                    ...
                    <li><a href="<?php echo e(route('progress')); ?>" <?php echo e($menu_active['progress']); ?>><?php echo e(isset($arrMenuText['menu_progress']) ? $arrMenuText['menu_progress'] :  __('Tiến độ')); ?></a></li>
                    <li><a href="<?php echo e(route('home')); ?>#infomationWrap" <?php echo e($menu_active['about']); ?>><?php echo e(isset($arrMenuText['menu_contact']) ? $arrMenuText['menu_contact'] :  __('Liên hệ')); ?></a>
                    </li>
                </ul>
    ...
    <footer class="pd1">
        <div class="container">
            <div class="topFooter">
                <div class="item">
                    <p><?php echo e(isset($arrFooterText['footer_invest']) ? $arrFooterText['footer_invest'] : 'ĐẦU TƯ VÀ PHÁT TRIỂN'); ?></p>
                ...
                <div class="item">
                    ...
                    <div class="itemText">
                        ...
                        <p><?php echo e(isset($arrFooterText['footer_address_sam_con']) ? $arrFooterText['footer_address_sam_con'] : 'Tòa nhà Miss Áo Dài, 21 Nguyễn Trung Ngạn, P. Bến Nghé, Quận 1, Tp. Hồ Chí Minh'); ?></p>
                    </div>
                </div>
                <div class="item">
                    <div class="itemText">
            ...
            <div class="botFooter">
                <div class="textFt">
                    <div class="item">
                        <p>
                            <?php echo e(isset($arrFooterText['footer_copyright']) ? $arrFooterText['footer_copyright'] : 'Bản quyền © 2022 CÔNG TY CỔ PHẦN BẤT ĐỘNG SẢN EMPIRE LAND.'); ?><br />
                            <?php echo e(isset($arrFooterText['footer_copyright2']) ? $arrFooterText['footer_copyright2'] : 'Tất cả quyền được bảo lưu. Giấy phép ĐKKD số 0316476518, do Sở KHĐT TP.HCM cấp ngày
                            18/11/2021.'); ?>
            ...
            <div class="left">
                ...
                <div class="top">
                    <p><img class="lazyload btnBackAr js-closefloorplandetail"
                            data-src="<?php echo e(asset('assets/images/btn-back.png')); ?>" alt=""> Mặt bằng toà / toà b / tầng 8 -
                        18</p>
