...
<div class="form-group row" :class="{'has-danger': errors.has('activated'), 'has-success': fields.activated && fields.activated.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-9'">
        ...
        <label class="form-check-label" for="activated">
            <?php echo e(trans('admin.admin-user.columns.activated')); ?>
...
<div class="form-group row" :class="{'has-danger': errors.has('forbidden'), 'has-success': fields.forbidden && fields.forbidden.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-9'">
        ...
        <label class="form-check-label" for="forbidden">
            <?php echo e(trans('admin.admin-user.columns.forbidden')); ?>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('roles'), 'has-success': fields.roles && fields.roles.valid }">
    <label for="roles" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'"><?php echo e(trans('admin.admin-user.columns.roles')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <multiselect v-model="form.roles" placeholder="<?php echo e(trans('brackets/admin-ui::admin.forms.select_options')); ?>" label="name" track-by="id" :options="<?php echo e($roles->toJson()); ?>" :multiple="true" open-direction="bottom"></multiselect>
        <div v-if="errors.has('roles')" class="form-control-feedback form-text" v-cloak>{{ errors.first('roles') }}</div>
    </div>
</div>
<?php /**PATH C:\xampp2\htdocs\legacy\resources\views/admin/admin-user/components/form-elements.blade.php ENDPATH**/ ?>