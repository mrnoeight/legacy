...
<main id="pMaster">
    ...
    <section id="LancasterTheMaster" class="serviceWrap pd1"
        data-image-src="<?php echo e(asset('assets/images/demo/bg-service.jpg')); ?>" data-parallax="scroll" data-bleed="0"
        data-speed="0.4">
        <div class="container">
    ...
    <section id="LancasterClub" class="lancasterClubWrap">
        <div class="contentLans des">
            <img class="lazyload bgClubDes" data-src="<?php echo e(asset('assets/images/demo/bg-club.jpg')); ?>" alt="">
            ...
            <div class="copyCard">
                ...
                <div class="text">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nisi, adipiscing convallis ut ut diam ut
                        praesent. Est pellentesque nulla ullamcorper nibh malesuada.Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit. Nisi, adipiscing convallis ut ut diam ut praesent. Est pellentesque
                    </p>
                </div>
            </div>
        </div>
