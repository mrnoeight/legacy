...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('web_title'), 'has-success': fields.web_title && fields.web_title.valid }">
    <label for="web_title" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.page.columns.web_title') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('web_description'), 'has-success': fields.web_description && fields.web_description.valid }">
    <label for="web_description" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.page.columns.web_description') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
