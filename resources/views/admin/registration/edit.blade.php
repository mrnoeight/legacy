...
@section('title', trans('admin.registration.actions.edit', ['name' => $registration->name]))
...
@section('body')
    ...
    <div class="container-xl">
            ...
            <registration-form
                :action="'{{ $registration->resource_url }}?stat={{ $stat }}'"
                ...
                <form class="form-horizontal form-edit" method="post" @submit.prevent="onSubmit" :action="action" novalidate>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-pencil"></i> {{ trans('admin.registration.actions.edit', ['name' => $registration->name]) }}
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-5 col-xxl-4">
                            @include('admin.registration.components.form-elements-right', ['showHistory' => true])
                        </div>
                    </div>
