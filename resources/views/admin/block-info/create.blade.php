    ...
    <div class="container-xl">
        ...
        <block-info-form
            ...
            <form class="form-horizontal form-create" method="post" @submit.prevent="onSubmit" :action="action" novalidate>
                ...
                @elseif (in_array($_GET['block_type'], array('lancaster_text', 'sidebar_text'))) 
                ...
                @elseif (in_array($_GET['block_type'], array('gallery_home', 'partner', 'gallery_photo')))
                    @include('admin.block-info.components.block_image')
                @elseif (in_array($_GET['block_type'], array('master_gallery')))
                    @include('admin.block-info.components.block_master_image')
                @elseif (substr($_GET['block_type'], 0, 2 ) == 'f_' || in_array($_GET['block_type'], array('slider_facilities', 'slider_facilities2')))
