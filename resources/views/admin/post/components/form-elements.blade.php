...
<div class="row">
    @foreach($locales as $locale)
        <div class="col"@if(!$loop->first) v-show="isFormLocalized && currentLocale == '{{ $locale }}'" v-cloak @endif>
            <div class="form-group row" :class="{'has-danger': errors.has('name_{{ $locale }}'), 'has-success': this.fields.name_{{ $locale }} && this.fields.name_{{ $locale }}.valid }">
                <label for="name_{{ $locale }}" class="col-md-2 col-form-label text-md-right">{{ trans('admin.post.columns.name') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <input type="text" v-model="form.name.{{ $locale }}" v-validate="'required'" class="form-control" :class="{'form-control-danger': errors.has('name_{{ $locale }}'), 'form-control-success': this.fields.name_{{ $locale }} && this.fields.name_{{ $locale }}.valid }" id="name_{{ $locale }}" name="name_{{ $locale }}" placeholder="{{ trans('admin.movie.columns.name') }}">
...
<!-- <div class="form-group row align-items-center" :class="{'has-danger': errors.has('name'), 'has-success': fields.name && fields.name.valid }">
    <label for="name" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.name') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.name" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('name'), 'form-control-success': fields.name && fields.name.valid}" id="name" name="name" placeholder="{{ trans('admin.post.columns.name') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('slug'), 'has-success': fields.slug && fields.slug.valid }">
    <label for="slug" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.slug') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.slug" v-validate="" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('slug'), 'form-control-success': fields.slug && fields.slug.valid}" id="slug" name="slug" placeholder="{{ trans('admin.post.columns.slug') }}">
...
<!-- <div class="form-group row align-items-center" :class="{'has-danger': errors.has('type'), 'has-success': fields.type && fields.type.valid }">
    <label for="type" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.type') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.type" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('type'), 'form-control-success': fields.type && fields.type.valid}" id="type" name="type" placeholder="{{ trans('admin.post.columns.type') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('city'), 'has-success': fields.city && fields.city.valid }">
    <label for="city" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.city') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('project_budget'), 'has-success': fields.project_budget && fields.project_budget.valid }">
    <label for="project_budget" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.project_budget') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="name"
            tag-placeholder="{{ __('Select Budget') }}"
...
<!-- <div class="form-group row align-items-center" :class="{'has-danger': errors.has('age'), 'has-success': fields.age && fields.age.valid }">
    <label for="age" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.age') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.age" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('age'), 'form-control-success': fields.age && fields.age.valid}" id="age" name="age" placeholder="{{ trans('admin.post.columns.age') }}">
...
<!-- <div class="form-group row align-items-center" :class="{'has-danger': errors.has('company_id'), 'has-success': fields.company_id && fields.company_id.valid }">
    <label for="company_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.company_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.company_id" v-validate="'integer'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('company_id'), 'form-control-success': fields.company_id && fields.company_id.valid}" id="company_id" name="company_id" placeholder="{{ trans('admin.post.columns.company_id') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('expired_date'), 'has-success': fields.expired_date && fields.expired_date.valid }">
    <label for="expired_date" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.expired_date') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.expired_date" :config="datePickerConfig"  class="flatpickr" :class="{'form-control-danger': errors.has('expired_date'), 'form-control-success': fields.expired_date && fields.expired_date.valid}" id="expired_date" name="expired_date" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('start_casting_date'), 'has-success': fields.start_casting_date && fields.start_casting_date.valid }">
    <label for="start_casting_date" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.start_casting_date') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('end_casting_date'), 'has-success': fields.end_casting_date && fields.end_casting_date.valid }">
    <label for="end_casting_date" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.end_casting_date') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.end_casting_date" :config="datePickerConfig"  class="flatpickr" :class="{'form-control-danger': errors.has('end_casting_date'), 'form-control-success': fields.end_casting_date && fields.end_casting_date.valid}" id="end_casting_date" name="end_casting_date" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('start_rehearsal_date'), 'has-success': fields.start_rehearsal_date && fields.start_rehearsal_date.valid }">
    <label for="start_rehearsal_date" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.start_rehearsal_date') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.start_rehearsal_date" :config="datePickerConfig"  class="flatpickr" :class="{'form-control-danger': errors.has('start_rehearsal_date'), 'form-control-success': fields.start_rehearsal_date && fields.start_rehearsal_date.valid}" id="start_rehearsal_date" name="start_rehearsal_date" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('end_rehearsal_date'), 'has-success': fields.end_rehearsal_date && fields.end_rehearsal_date.valid }">
    <label for="end_rehearsal_date" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.end_rehearsal_date') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.end_rehearsal_date" :config="datePickerConfig"  class="flatpickr" :class="{'form-control-danger': errors.has('end_rehearsal_date'), 'form-control-success': fields.end_rehearsal_date && fields.end_rehearsal_date.valid}" id="end_rehearsal_date" name="end_rehearsal_date" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('start_photo_date'), 'has-success': fields.start_photo_date && fields.start_photo_date.valid }">
    <label for="start_photo_date" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.start_photo_date') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.start_photo_date" :config="datePickerConfig"  class="flatpickr" :class="{'form-control-danger': errors.has('start_photo_date'), 'form-control-success': fields.start_photo_date && fields.start_photo_date.valid}" id="start_photo_date" name="start_photo_date" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('end_photo_date'), 'has-success': fields.end_photo_date && fields.end_photo_date.valid }">
    <label for="end_photo_date" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.end_photo_date') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.end_photo_date" :config="datePickerConfig"  class="flatpickr" :class="{'form-control-danger': errors.has('end_photo_date'), 'form-control-success': fields.end_photo_date && fields.end_photo_date.valid}" id="end_photo_date" name="end_photo_date" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
...
<div class="row">
    @foreach($locales as $locale)
        <div class="col"@if(!$loop->first) v-show="isFormLocalized && currentLocale == '{{ $locale }}'" v-cloak @endif>
            <div class="form-group row" :class="{'has-danger': errors.has('{{ $locale }}_short_desc'), 'has-success': this.fields.{{ $locale }}_short_desc && this.fields.{{ $locale }}_short_desc.valid }">
                <label for="{{ $locale }}_short_desc" class="col-md-2 col-form-label text-md-right">{{ trans('admin.post.columns.description') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <div class="input-group input-group--custom">
                        <textarea v-model="form.short_desc.{{ $locale }}" v-validate="'required'" style="width:100%"  id="{{ $locale }}_short_desc" name="{{ $locale }}_short_desc"></textarea>
                        
                    </div>
                    <div v-if="errors.has('{{ $locale }}_short_desc')" class="form-control-feedback form-text" v-cloak>{{'{{'}} errors.first('{{ $locale }}_short_desc') }}</div>
                </div>
            </div>
        </div>
    @endforeach
...
<!-- <div class="row">
    @foreach($locales as $locale)
        <div class="col"@if(!$loop->first) v-show="isFormLocalized && currentLocale == '{{ $locale }}'" v-cloak @endif>
            <div class="form-group row" :class="{'has-danger': errors.has('{{ $locale }}_description'), 'has-success': this.fields.{{ $locale }}_description && this.fields.{{ $locale }}_description.valid }">
                <label for="{{ $locale }}_short_desc" class="col-md-2 col-form-label text-md-right">{{ trans('admin.post.columns.description') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <div>
                        <wysiwyg v-model="form.description.{{ $locale }}" v-validate="'required'" id="{{ $locale }}_description" name="{{ $locale }}_description" :config="mediaWysiwygConfig" />
                    </div>
                    <div v-if="errors.has('{{ $locale }}_description')" class="form-control-feedback form-text" v-cloak>{{'{{'}} errors.first('{{ $locale }}_description') }}</div>
                </div>
            </div>
        </div>
    @endforeach
...
<!-- <div class="form-group row align-items-center" :class="{'has-danger': errors.has('short_desc'), 'has-success': fields.short_desc && fields.short_desc.valid }">
    <label for="short_desc" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.short_desc') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
