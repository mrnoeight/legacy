...
@section('title', trans('admin.post.actions.edit', ['name' => $post->name]))
...
@section('body')
    ...
    <div class="container-xl">
            ...
            <post-form
                ...
                :post-type="{{ $post_type->toJson() }}"
                :gender="{{ json_encode($genders) }}"
                :project_budget="{{ json_encode($project_budget) }}"
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-pencil"></i> {{ trans('admin.post.actions.edit', ['name' => $post->name]) }}
                                </div>
                                <div class="card-body">
