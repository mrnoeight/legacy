                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'representative'">{{ trans('admin.company.columns.representative') }}</th>
                                        <th is='sortable' :column="'tel'">{{ trans('admin.company.columns.tel') }}</th>
                                        <th is='sortable' :column="'address'">{{ trans('admin.company.columns.address') }}</th>
                                        <th is='sortable' :column="'city'">{{ trans('admin.company.columns.city') }}</th>
                                        <th is='sortable' :column="'enabled'">{{ trans('admin.company.columns.enabled') }}</th>
