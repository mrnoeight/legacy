                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' class="text-center" :column="'published_at'">{{ trans('admin.event.columns.published_at') }}</th>
                                        <th is='sortable' :column="'enabled'">{{ trans('admin.event.columns.enabled') }}</th>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        <td>@{{ item.title }}</td>
                                            ...
                                            <span v-if="item.published_at <= now">
                                                ...
                                                <span v-if="item.published_at > now">
                                                <small>{{ trans('admin.event.actions.will_be_published') }}</small><br />
                                                @{{ item.published_at | datetime('DD.MM.YYYY, HH:mm') }}
