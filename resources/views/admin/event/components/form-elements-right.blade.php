<div class="card">
    ...
    <div class="card-block">
        ...
        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('published_at'), 'has-success': fields.published_at && fields.published_at.valid }">
            <label for="published_at" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-2' : 'col-md-4'">{{ trans('admin.event.columns.published_at') }}</label>
...
<div class="card">
    <div class="card-header">
        <i class="fa fa-check"></i>{{ trans('Gallery') }}
    </div>
    <div class="card-block">
        <div class="form-group row align-items-center">
        @if ($mode === 'create')
