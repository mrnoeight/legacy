        ...
        <div class="main-ctr wrap-1200">
            <div class="logo-wrap">
                ...
                <a href="{{ route('home') }}" class="logo">
                    @if (isset($talent))
                    <img src="{{ asset('assets/img/bg/logo-black.svg') }}" alt="Take1 logo" />
                    @else
                    <img src="{{ asset('assets/img/bg/logo.svg') }}" alt="Take1 logo" />
                    @endif
                </a>
            </div>
            @if (isset($client))
            <nav class="main-menu">
                ...
                <ul class="top-menu">
                    <li class="top-item"><a href="{{ route('client_casting_board') }}" class="active">
                            <h5>MANAGE PROJECT </h5>
                        </a></li>
                    <li class="top-item"><a href="{{ route('client_talent_list') }}">
            ...
            <nav class="main-menu">
                ...
                <ul class="top-menu">
                    <!-- SWITCH HERE -->
                    <li class="top-item"><a href="{{ route('talent_casting_board') }}"><h5>CASTING BILLBOARDS</h5></a></li>
                    <li class="top-item"><a href="{{ route('talent_manage_role') }}" ><h5>MANAGE ROLES </h5></a></li>
            ...
            <nav class="main-menu">
                <h4 class="heading">Menu</h4>
                <ul class="top-menu">
                    <li class="top-item"><a href="{{ route('casting_board') }}" {{$menu_active['casting_board']}}>
                            <h5>CASTING BOARD</h5>
                        </a></li>
                    <li class="top-item"><a href="{{ route('our_talent') }}" {{$menu_active['our_talent']}}>
                            <h5>MEET OUR TALENTS</h5>
                        </a></li>
                    <li class="top-item has-sub">
                        <a href="{{ route('talent_service') }}" {{$menu_active['talent_service']}}>
                            <h5>TALENT SERVICES</h5>
                            <b role="button" class="icon-sub"><i></i></b>
                        </a>
                        <div class="sub-menu">
                            <h5 class="title">
                                <a href="{{ route('talent_service') }}" {{$menu_active['talent_service']}}>TALENT SERVICES</a>
                            </h5>
                            <ul class="aside">
                                <li class="sub-item">
                                    <a href="{{ route('talent_service') }}" {{$menu_active['talent_service']}}>
                            ...
                            <div class="main-cta">
                                ...
                                <a href="{{ route('signup') }}#signup-talent" role="button" class="btn-gold cta type-2">JOIN as a
                                    talent</a>
                            </div>
                        </div>
                    </li>
                    <li class="top-item has-sub">
                        <a href="{{ route('casting_service') }}" {{$menu_active['casting_service']}}>
                            <h5>CASTING SERVICES</h5>
                            <b role="button" class="icon-sub"><i></i></b>
                        </a>
                        <div class="sub-menu">
                            <h5 class="title">
                                <a href="{{ route('casting_service') }}" {{$menu_active['casting_service']}}>CASTING SERVICES</a>
                            </h5>
                            <ul class="aside">
                                <li class="sub-item">
                                    <a href="{{ route('casting_service') }}" {{$menu_active['casting_service']}}>
                            ...
                            <div class="main-cta">
                                ...
                                <a href="{{ route('signup') }}#signup-client" role="button" class="btn-gold cta type-2">JOIN as a
                                    client</a>
                            </div>
                        </div>
                    </li>
                    <li class="top-item has-sub">
                        <a href="{{ route('about') }}" {{$menu_active['about_us']}}>
                            <h5>ABOUT US</h5>
                            <b role="button" class="icon-sub"><i></i></b>
                        </a>
                        <div class="sub-menu type-mini">
                            <h5 class="title"><a href="{{ route('about') }}" {{$menu_active['about_us']}}>ABOUT US</a></h5>
                            <ul class="aside">
                                <li class="sub-item">
                                    <a href="{{ route('about') }}" {{$menu_active['about_us']}}>
                                        <h6>About Us</h6>
                                ...
                                <li class="sub-item">
                                    <a href="{{ config('app.url') }}/news-events">
                                        <h6>News & Event</h6>
                                    </a>
                                </li>
                            </ul>
                            <div class="main-cta">
                                <div class="wrap">
                                    <ul class="list-bullet type-2">
                                        <li><a href="{{ route('about') }}" {{$menu_active['about_us']}}>About Us</a></li>
                                        <li><a href="{{ config('app.url') }}/news-events">News & Event</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            $user = Auth::user();
            @endphp
            @if ($user->type == \App\Models\Registration::TALENT)
            <div class="user-logged">
                <div class="wrap-noti">
                    ...
                    <div class="panel">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('talent_role_request', ['id'=>$m->request_id, 'role_id'=>$m->prole_id]) }}" class="item js-active">
                                    <div class="img-wrap"><img src="{{ $m->company->thumb_url }}" alt="{{ $m->type }}" /></div>
                                    <p class="content">
                                        <strong>{{ $m->type }}</strong>
                                        <span>{{ $m->message }}</span>
                                        <time datetime="">{{ tk1BetweenDates(date("Y/m/d"), $m->created_at) }} ago</time>
                                    </p>
                                </a>
                            </li>
                            @endforeach
                ...
                <div class="wrap-panel">
                    <a href="{{ route('talent_profile') }}" role="button" class="btn-active">
                        <div class="img-wrap-circle"><img src="{{ $user->cover_url }}" alt="{{ $user->name }}"/></div>
                        <b>{{ $user->name }}</b>
                    </a>
                    <div class="user-panel">
                        ...
                        <a href="{{ route('talent_manage_role') }}" role="button" class="btn-gold cta">role management</a>
                        <nav>
                            <h5 class="hidden">User Profile</h5>
                            <ul>
                                <li><a href="{{ route('talent_profile') }}">
                                        <h6>Your Profile</h6>
                                    </a></li>
                                <li><a href="{{ route('talent_account') }}">
                                        <h6>Account Information</h6>
                                    </a></li>
                                <li><a href="{{ route('talent_membership') }}">
            ...
            <div class="user-logged">
                <div class="wrap-noti">
                    ...
                    <div class="panel">
                        ...
                        <ul>
                            @foreach ($user->company->messages as $m)
                            <li>
                                <a href="{{ route('client_requested_role', ['id'=>$m->prole_id]) }}" class="item js-active">
                                    <div class="img-wrap"><img src="{{ $m->registration->cover_url }}" alt="{{ $m->type }}" /></div>
                                    <p class="content">
                                        <strong>{{ $m->type }}</strong>
                                        <span>{{ $m->message }}</span>
                                        <time datetime="">{{ tk1BetweenDates(date("Y/m/d"), $m->created_at) }} ago</time>
                ...
                <div class="wrap-panel">
                    <a href="{{ route('client_profile') }}" role="button" class="btn-active">
                        <div class="img-wrap-circle"><img src="{{ $user->company->thumb_url }}" alt="{{ $user->company->name }}" /></div>
                    ...
                    <div class="user-panel">
                        ...
                        <a href="{{ route('client_dashboard') }}" role="button" class="btn-gold cta">project management</a>
                        <nav>
                            <h5 class="hidden">User Profile</h5>
                            <ul>
                                <li><a href="{{ route('client_profile') }}">
                                        <h6>Your Profile</h6>
                                    </a></li>
                                <li><a href="{{ route('client_account_info') }}">
                                        <h6>Account Information</h6>
                                    </a></li>
                                <li><a href="{{ route('client_membership') }}">
            ...
            <nav class="btn-wrap">
                ...
                <a href="{{ config('app.url') }}/signup" role="button" class="btn-user">
                    <h6>sign up</h6>
                </a>
                <a href="{{ config('app.url') }}/login" role="button" class="btn-txt">
                    <h6>log in</h6>
                </a>
                <a href="#" role="button" class="btn-lang">
                    <img src="{{ asset('assets/img/flag/en.svg') }}" alt="en flag" />
                </a>
                <a href="{{ config('app.url') }}/login" role="button" class="btn-user-mb"></a>
            </nav>
            @endif
        </div>
    </header>
            ...
            <li class="top-item has-sub">
                ...
                <div class="sub-menu">
                    ...
                    <div class="main-cta">
                        ...
                        <a href="{{ route('signup') }}#signup-talent" role="button" class="btn-gold cta type-2">JOIN as a talent</a>
                    </div>
                </div>
            </li>
            <li class="top-item has-sub">
                ...
                <div class="sub-menu">
                    <!--h5 class="title">
		                		<a href="{{ route('talent_service') }}" {{$menu_active['talent_service']}}>CASTING SERVICES</a>
		                </h5-->
                    <ul class="aside">
                        <li class="sub-item">
                            <a href="{{ route('casting_service') }}" {{$menu_active['casting_service']}}>
