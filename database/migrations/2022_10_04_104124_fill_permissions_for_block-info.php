...
class FillPermissionsForBlockInfo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBlockInfo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.block-info',
            'admin.block-info.index',
            'admin.block-info.create',
            'admin.block-info.show',
            'admin.block-info.edit',
            'admin.block-info.delete',
            'admin.block-info.bulk-delete',
        ]);
