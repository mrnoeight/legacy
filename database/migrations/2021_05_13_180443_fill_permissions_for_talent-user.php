...
class FillPermissionsForTalentUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTalentUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.talent-user',
            'admin.talent-user.index',
            'admin.talent-user.create',
            'admin.talent-user.show',
            'admin.talent-user.edit',
            'admin.talent-user.delete',
            'admin.talent-user.bulk-delete',
        ]);
